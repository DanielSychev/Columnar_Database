...
struct NumericSumVisitor : public ColumnVisitor {
    ...
    void Visit(const Int128Column& col, const std::vector<size_t>& gi, size_t mg) override { IntegralVisit(col, gi, mg); }
    ...
    void Visit(const StrColumn&,       const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericSumVisitor: str column"); }
    void Visit(const DateColumn&,      const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericSumVisitor: date column"); }
    void Visit(const TimeStampColumn&, const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericSumVisitor: timestamp column"); }
...
struct NumericAvgVisitor : public ColumnVisitor {
    ...
    void Visit(const StrColumn&,       const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericAvgVisitor: str column"); }
    void Visit(const DateColumn&,      const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericAvgVisitor: date column"); }
    void Visit(const TimeStampColumn&, const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericAvgVisitor: timestamp column"); }
...
struct NumericMaxVisitor : public ColumnVisitor {
    ...
    void Visit(const StrColumn&,       const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericMaxVisitor: str column"); }
    void Visit(const DateColumn&,      const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericMaxVisitor: date column"); }
    void Visit(const TimeStampColumn&, const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericMaxVisitor: timestamp column"); }
...
struct NumericMinVisitor : public ColumnVisitor {
    ...
    void Visit(const StrColumn&,       const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericMinVisitor: str column"); }
    void Visit(const DateColumn&,      const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericMinVisitor: date column"); }
    void Visit(const TimeStampColumn&, const std::vector<size_t>&, size_t) override { throw std::runtime_error("NumericMinVisitor: timestamp column"); }
